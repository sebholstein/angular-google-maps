    ...
    it('should set the map to null when deleting a existing rectangle',
       inject(
           ...
           (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             ...
             const rectangleInstance: any = {setMap: jest.fn()};
             (<jest.Mock>apiWrapper.createRectangle)
    ...
    it('should update that rectangle via setBounds method when the bounds changes',
       async(inject(
           ...
           (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             ...
             const rectangleInstance: Rectangle = <any>{setMap: jest.fn(), setBounds: jest.fn()};
             (<jest.Mock>apiWrapper.createRectangle)
                 .mockReturnValue(Promise.resolve(rectangleInstance));
             ...
             const bounds = {north: 15.6, east: 45.2, south: 12.6, west: 41.3};
    ...
    it('should update that rectangle via setOptions method when the options changes',
       async(inject(
           ...
           (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             ...
             const rectangleInstance: any = {setMap: jest.fn(), setOptions: jest.fn()};
             ...
             const options = {fillOpacity: 0.6, strokeOpacity: 0.6};
    ...
    it('should update that rectangle via setOptions method when the options changes',
       async(inject(
           ...
           (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             ...
             const options = {fillColor: '#00008B', strokeColor: '#00008B'};
    ...
    it('should update that rectangle via setVisible method when the visible changes',
       async(inject(
           ...
           (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             ...
             const rectangleInstance: any = {setMap: jest.fn(), setVisible: jest.fn()};
             (<jest.Mock>apiWrapper.createRectangle)
                 .mockReturnValue(Promise.resolve(rectangleInstance));
