...
describe('RectangleManager', () => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        RectangleManager, {
          ...
          useValue: jasmine.createSpyObj('GoogleMapsAPIWrapper', ['createRectangle'])
        }
      ]
    });
  });
  ...
  describe('Create a new rectangle', () => {
    it('should call the mapsApiWrapper when creating a new rectangle',
       inject(
           [RectangleManager, GoogleMapsAPIWrapper],
           (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
  ...
  describe('Delete a rectangle', () => {
    it('should set the map to null when deleting a existing rectangle',
       inject(
           [RectangleManager, GoogleMapsAPIWrapper],
           (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             const newRectangle = new AgmRectangle(rectangleManager);
             ...
             const rectangleInstance: Rectangle = jasmine.createSpyObj('Rectangle', ['setMap']);
             (<any>apiWrapper.createRectangle).and.returnValue(Promise.resolve(rectangleInstance));
  ...
  describe('Set bounds option', () => {
    it('should update that rectangle via setBounds method when the bounds changes',
      async(inject(
        [RectangleManager, GoogleMapsAPIWrapper],
        (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
          const newRectangle = new AgmRectangle(rectangleManager);
          ...
          const rectangleInstance: Rectangle = jasmine.createSpyObj('Rectangle', ['setMap', 'setBounds']);
          (<any>apiWrapper.createRectangle).and.returnValue(Promise.resolve(rectangleInstance));
  ...
  describe('Set fill/stroke opacity option', () => {
    it('should update that rectangle via setOptions method when the options changes',
      async(inject(
        [RectangleManager, GoogleMapsAPIWrapper],
        (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
          const newRectangle = new AgmRectangle(rectangleManager);
          ...
          const rectangleInstance: Rectangle = jasmine.createSpyObj('Rectangle', ['setMap', 'setOptions']);
          (<any>apiWrapper.createRectangle).and.returnValue(Promise.resolve(rectangleInstance));
  ...
  describe('Set visible option', () => {
    it('should update that rectangle via setVisible method when the visible changes',
       async(inject(
           [RectangleManager, GoogleMapsAPIWrapper],
           (rectangleManager: RectangleManager, apiWrapper: GoogleMapsAPIWrapper) => {
             const newRectangle = new AgmRectangle(rectangleManager);
             ...
             const rectangleInstance: Rectangle = jasmine.createSpyObj('Rectangle', ['setMap', 'setVisible']);
             (<any>apiWrapper.createRectangle).and.returnValue(Promise.resolve(rectangleInstance));
