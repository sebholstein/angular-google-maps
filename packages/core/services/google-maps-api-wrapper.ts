...
export class GoogleMapsAPIWrapper {
   ...
   * @param {IVisibility} options - used for setting layer options
   * @returns {Promise<TransitLayer>} a new transit layer object
   */
  createTransitLayer(options: IVisibility): Promise<google.maps.TransitLayer>{
    return this._map.then((map: google.maps.Map) => {
   ...
   */
  createBicyclingLayer(options: IVisibility): Promise<google.maps.BicyclingLayer>{
    return this._map.then((map: google.maps.Map) => {
