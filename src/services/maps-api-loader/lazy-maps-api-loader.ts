...
export class LazyMapsAPILoaderConfig {
   ...
   * A channel parameter is an optional parameter that allows you to track usage under your client ID
   * by assigning a distinct channel to each of your applications.
   */
  channel: string = null;
